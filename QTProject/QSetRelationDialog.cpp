...
QSetRelationDialog::~QSetRelationDialog()
{
	...
	if(leftStandardModle != NULL)
	{
		delete leftStandardModle;
		leftStandardModle = NULL;
	}
	if(rightStandardModle != NULL)
	{
		delete rightStandardModle;
		rightStandardModle = NULL;
	}
	...
	if(relationListBox != NULL)
	{
		delete relationListBox;
		relationListBox = NULL;
	}

	if(topImageLabel != NULL)
	{
		delete topImageLabel;
		topImageLabel = NULL;
	}
	if(buttonImageLabel != NULL)
	{
		delete buttonImageLabel;
		buttonImageLabel = NULL;
	}
