...
int MaskValue(unsigned char *r, POINTT ImageSize, int j, int k, int l, int MaskNum, POINTT *MaskCoor, float *MaskWeight)
{
	int		i;
	float	tmp;
...
void GRAYSCALEEdgeSobel(unsigned char *dest, unsigned char *src, POINTT ImageSize)
{
