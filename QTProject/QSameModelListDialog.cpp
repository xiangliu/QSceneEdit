...
QSameModelListDialog::~QSameModelListDialog()
{

}

//用于载入检索结果列表
void QSameModelListDialog::DownloadModelImage(int windWidth, int windHeight)
{
...
//用于记录用户挑选的是哪个模型
void QSameModelListDialog::mouseDoubleClickEvent(QMouseEvent *event) 
{
