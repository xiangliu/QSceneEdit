...
struct AccumDCurv {
	void operator() (const TriMesh *themesh, int v0, TriVec<4> &d,
			 float w, int v) const
	{
		TriVec<4> ndcurv;
...
template void diffuse_vector< TriVec<2,float> >(TriMesh *, vector< TriVec<2,float> > &, float);
template void diffuse_vector< TriVec<3,float> >(TriMesh *, vector< TriVec<3,float> > &, float);
template void diffuse_vector< TriVec<4,float> >(TriMesh *, vector< TriVec<4,float> > &, float);
